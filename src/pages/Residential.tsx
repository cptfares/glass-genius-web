...
const residentialServices = [
  {
    ...
    description:
      "Fix broken windows or upgrade to energy-efficient options for your home.",
    link: "/services/window-replacement",
  },
  {
    title: "Glass Door Installation",
    description:
      "Beautiful sliding glass doors, french doors, and patio doors for your home.",
    link: "/services/glass-doors",
  },
  {
    title: "Shower Enclosures",
    description:
      "Custom shower doors and enclosures to transform your bathroom.",
    link: "/services/shower-enclosures",
  },
  {
    title: "Mirror Installation",
    description:
      "Custom mirrors for bathrooms, bedrooms, and decorative purposes.",
    link: "/services/mirrors",
  },
  {
    title: "Glass Tabletops",
    description:
      "Custom glass tops for tables, desks, and furniture protection.",
      ...
      <div className="relative bg-brand-dark">
        ...
        <div className="container relative z-10 px-4 py-20 mx-auto text-center text-white">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Elevate your home with custom glass solutions. From window
            replacements to shower enclosures, we provide quality residential
            glass services.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="bg-white text-brand-dark border-white hover:bg-white/90"
            >
      ...
      <div className="container px-4 py-16 mx-auto">
        <div className="max-w-4xl mx-auto mb-16">
          <h2 className="text-3xl font-bold mb-6">
            Enhance Your Home With Quality Glass
          </h2>
          <p className="text-lg text-gray-700 mb-6">
            At Glass Genius, we provide comprehensive residential glass services
            to enhance the beauty, functionality, and value of your home. Our
            expert technicians specialize in everything from window replacements
            to custom shower enclosures and decorative glass features.
          </p>
          <p className="text-lg text-gray-700 mb-6">
            We understand that your home is your sanctuary, which is why we take
            extra care to ensure clean installation, minimal disruption, and
            exceptional results. Our residential glass services are designed to
            meet your specific needs and preferences while adhering to the
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-10 text-center">
            Our Residential Glass Solutions
          </h2>
