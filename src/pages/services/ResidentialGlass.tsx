        ...
        content={
          <>
            <p>
              ...
              homeowners throughout Washington D.C., Northern Virginia, and
              Maryland. Our residential glass solutions enhance your home's
              beauty, functionality, and value while meeting your specific needs
              and preferences.
            </p>
            <p className="mt-4">
            ...
            <p className="mt-4">
              ...
              professional installation, we ensure a smooth process and
              exceptional results. Whether you're replacing broken glass or
              undertaking a major renovation, Glass Genius delivers beautiful,
              durable, and functional glass solutions for homes throughout the
              DMV region.
            </p>
          </>
        }
