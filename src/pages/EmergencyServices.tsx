      ...
      <div className="relative bg-brand-dark">
        ...
        <div className="container relative z-10 px-4 py-20 mx-auto text-center text-white">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-8">
            Fast response when you need it most. We provide emergency glass
            repair services around the clock for residential and commercial
            properties.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                Our emergency services are available 24 hours a day, 7 days a
                week, 365 days a year. We understand that glass emergencies can
                happen at any time, and we're always ready to help.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                Our team aims to arrive at your location as quickly as possible,
                typically within 60-90 minutes of your call, depending on your
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                We'll secure your property by boarding up broken windows or
                doors until permanent repairs can be made, ensuring your home or
            ...
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                We provide transparent pricing even for emergency services.
                While emergency rates may apply, we'll always be upfront about
          ...
          <div className="bg-brand-blue/10 p-8 rounded-lg mb-16">
            <h3 className="text-2xl font-bold mb-4">
              Common Emergency Glass Situations We Handle:
            </h3>
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2">
                <Clock className="text-brand-blue h-5 w-5 mt-1 flex-shrink-0" />
                <span>
                  Damaged glass doors that won't close or lock properly
                </span>
              </li>
              <li className="flex items-start gap-2">
                <Clock className="text-brand-blue h-5 w-5 mt-1 flex-shrink-0" />
