      ...
      <section className="py-16 bg-gray-50">
        <div className="container px-4 mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Glass Services</h2>
            <p className="text-gray-600">
              We offer a comprehensive range of glass repair and installation services for both commercial and residential properties.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-white/80 mb-8">
                Contact us today for a free estimate. We provide professional glass repair and installation services for both commercial and residential properties in Reston, Virginia and surrounding areas.
              </p>
              ...
              <p className="text-white/80">
                Serving Reston, Virginia and a 20-mile radius, including Herndon, Vienna, Tysons, Falls Church, Fairfax, Ashburn, Sterling, Chantilly, McLean, Oakton, Great Falls, Centreville, Manassas, and more.
              </p>
            </div>
